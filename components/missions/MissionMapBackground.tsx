...
/**
 * Fondos SVG procedurales muy detallados, con referencias densas
 * a la mitología vasca. Cada mapa tiene capas: cielo, fondo lejano,
 * fondo medio, elementos cercanos, y detalles animados.
 */
...
// ============================================================
// ANBOTO — Mari y sus rayos sobre la cumbre sagrada
// ============================================================
function AnbotoMap() {
  return (
    <g>
      <defs>
        ...
        <radialGradient id="anboto-aura" cx="0.5" cy="0.3" r="0.5">
          <stop offset="0%" stopColor="#FFD53D" stopOpacity="0.4" />
      ...
      {/* Tres rayos secuenciales */}
      <path d="M 220 30 L 200 100 L 220 100 L 195 180 L 240 100 L 220 100 Z" fill="#FFD53D">
        <animate attributeName="opacity" values="0;0.95;0;0;0;0;0;0" dur="6s" repeatCount="indefinite" />
      </path>
      <path d="M 560 60 L 540 130 L 560 130 L 535 220 L 580 130 L 560 130 Z" fill="#FFFDE7">
        <animate attributeName="opacity" values="0;0;0;0.9;0;0;0;0" dur="6s" repeatCount="indefinite" />
      </path>
      <path d="M 920 40 L 900 120 L 920 120 L 895 200 L 940 120 L 920 120 Z" fill="#FFD53D">
        <animate attributeName="opacity" values="0;0;0;0;0;0.95;0;0" dur="6s" repeatCount="indefinite" />
      </path>

      {/* Aitzkorri detrás */}
      <path d="M 0 410 L 100 360 L 200 390 L 320 330 L 450 370 L 580 320 L 720 370 L 850 330 L 980 370 L 1100 340 L 1200 390 L 1200 600 L 0 600 Z"
        fill="#2A2438" opacity="0.65" />

      {/* Anboto principal */}
      <path d="M 200 600 L 280 480 L 360 420 L 440 350 L 520 270 L 580 200 L 600 165 L 620 200 L 680 270 L 760 350 L 840 420 L 920 480 L 1000 600 Z"
        fill="#1F1A2A" />
      {/* Sombra del flanco derecho */}
      <path d="M 600 165 L 620 200 L 680 270 L 760 350 L 840 420 L 920 480 L 1000 600 L 600 600 Z"
        fill="#0F0A18" opacity="0.7" />

      {/* Sendero zigzagueante hacia la cumbre */}
      <path d="M 600 165 Q 580 210 605 245 Q 630 280 600 320 Q 575 360 605 405 Q 635 445 600 490 Q 565 530 605 575"
        fill="none" stroke="#5A4A6B" strokeWidth="2.5" strokeDasharray="6 4" opacity="0.55" />

      {/* Castillo de Mari en la cumbre */}
      <g>
        {/* Torre central */}
        <rect x="585" y="170" width="30" height="28" fill="#0A0612" />
        <path d="M 580 172 L 600 152 L 620 172 Z" fill="#0A0612" />
        {/* Almenas */}
        <rect x="583" y="170" width="6" height="4" fill="#0A0612" />
        <rect x="597" y="170" width="6" height="4" fill="#0A0612" />
        <rect x="611" y="170" width="6" height="4" fill="#0A0612" />
        {/* Ventanas con fuego dorado */}
        <rect x="591" y="180" width="5" height="9" fill="#FFD53D">
          <animate attributeName="opacity" values="0.9;0.4;0.9" dur="2s" repeatCount="indefinite" />
        </rect>
        <rect x="604" y="180" width="5" height="9" fill="#FFD53D">
          <animate attributeName="opacity" values="0.4;0.9;0.4" dur="2.4s" repeatCount="indefinite" />
        </rect>
        {/* Puerta arqueada */}
        <path d="M 596 198 L 596 192 Q 600 188 604 192 L 604 198 Z" fill="#1A0F08" />
        {/* Pequeña bandera */}
        <line x1="600" y1="152" x2="600" y2="142" stroke="#1A1A2E" strokeWidth="1" />
        <path d="M 600 142 L 608 144 L 600 148 Z" fill="#C24617" />
      </g>

      {/* Cuervos en silueta */}
      <g fill="#0A0612">
        <path d="M 320 180 q 9 -7 18 0 q -9 -3 -18 0 z" />
        <path d="M 380 210 q 7 -6 14 0 q -7 -2 -14 0 z" />
        <path d="M 430 175 q 9 -7 18 0 q -9 -3 -18 0 z" />
        <path d="M 780 195 q 8 -6 16 0 q -8 -2 -16 0 z" />
        <path d="M 850 225 q 7 -6 14 0 q -7 -2 -14 0 z" />
        <path d="M 900 175 q 10 -8 20 0 q -10 -3 -20 0 z" />
        <path d="M 180 245 q 7 -5 14 0 q -7 -2 -14 0 z" />
        <path d="M 1020 230 q 8 -6 16 0 q -8 -2 -16 0 z" />
      </g>

      {/* Niebla en la base */}
      <ellipse cx="600" cy="525" rx="600" ry="60" fill="#5A4A6B" opacity="0.4" filter="url(#anboto-mist)" />
      <ellipse cx="300" cy="545" rx="320" ry="40" fill="#7B6B8B" opacity="0.3" filter="url(#anboto-mist)" />
      <ellipse cx="900" cy="545" rx="340" ry="40" fill="#7B6B8B" opacity="0.3" filter="url(#anboto-mist)" />
    </g>
  )
}

// ============================================================
// ITSASOA — Lamia peinándose, atardecer, mar de espuma
// ============================================================
function ItsasoaMap() {
  return (
    <g>
      ...
      {/* Acantilados lejanos a la izquierda */}
      <path d="M 0 380 L 0 280 L 60 260 L 140 290 L 220 270 L 280 300 L 320 290 L 380 310 L 440 300 L 500 320 L 540 330 L 580 350 L 620 380 Z"
        fill="#3D2A3D" opacity="0.7" />
      {/* Casa pesquera en el acantilado */}
      <g>
        <rect x="180" y="262" width="24" height="22" fill="#8B6F3A" />
        <path d="M 178 262 L 192 250 L 206 262 Z" fill="#C24617" />
        <rect x="186" y="270" width="5" height="8" fill="#FFD53D" opacity="0.85">
          <animate attributeName="opacity" values="0.85;0.5;0.85" dur="3s" repeatCount="indefinite" />
        </rect>
        <rect x="195" y="270" width="5" height="8" fill="#FFD53D" opacity="0.7" />
      </g>

      {/* Gaviotas */}
      <g fill="#FFFDE7" opacity="0.9">
        <path d="M 320 200 q 11 -9 22 0 q -11 -4 -22 0 z" />
        <path d="M 480 250 q 8 -7 16 0 q -8 -3 -16 0 z" />
        <path d="M 780 180 q 12 -10 24 0 q -12 -4 -24 0 z" />
        <path d="M 230 260 q 8 -6 16 0 q -8 -2 -16 0 z" />
        <path d="M 650 230 q 7 -6 14 0 q -7 -2 -14 0 z" />
        <path d="M 900 130 q 9 -7 18 0 q -9 -3 -18 0 z" />
      </g>
      ...
      {/* Isla grande con árbol — donde está la lamia */}
      ...
      <g fill="none" stroke="#FFFDE7" strokeWidth="1.5" opacity="0.6">
        ...
        <path d="M 550 520 Q 580 515 610 520 T 670 520" />
...
// ============================================================
// BASOA — Bosque profundo con basajaun y hongos
// ============================================================
function BasoaMap() {
  return (
    <g>
      ...
      <g fill="#3D2A20">
        ...
        {/* Tronco extra al centro-derecha */}
      ...
      {/* Detalles en corteza */}
      <g stroke="#2A1F14" strokeWidth="0.8" fill="none" opacity="0.6">
        <path d="M 100 300 L 100 600" />
        <path d="M 118 300 L 118 600" />
        <path d="M 240 250 L 240 600" />
        <path d="M 940 250 L 940 600" />
      </g>
      ...
      <path d="M 0 480 Q 200 460 400 475 Q 600 485 800 470 Q 1000 480 1200 465" fill="none" stroke="#3D2A20" strokeWidth="2" />

      {/* Riachuelo */}
      <path d="M 470 600 Q 510 570 490 540 Q 470 510 510 480 Q 540 460 525 440" stroke="#5BA8B8" strokeWidth="6" fill="none" opacity="0.7" />
      <path d="M 470 600 Q 510 570 490 540 Q 470 510 510 480 Q 540 460 525 440" stroke="#A8DFE6" strokeWidth="2" fill="none" opacity="0.5" />
      ...
      <g>
        {[{ x: 320, y: 562 }, { x: 460, y: 575 }, { x: 680, y: 568 }, { x: 850, y: 580 }, { x: 1050, y: 565 }].map((p, i) => (
          <g key={i}>
            <path d={`M ${p.x} ${p.y} Q ${p.x} ${p.y - 18} ${p.x + 12} ${p.y - 18} Q ${p.x + 24} ${p.y - 18} ${p.x + 24} ${p.y} Z`} fill="#C24617" />
      ...
      {/* Mariposa */}
      <g transform="translate(580, 360)" fill="#FFD53D" opacity="0.85">
      ...
      {/* Basajaun más visible */}
      <g opacity="0.7" fill="#0E0A08">
...
// ============================================================
// KOBAZULOA — Cueva de jentilak con pinturas rupestres
// ============================================================
function KobazuloaMap() {
  return (
    <g>
      ...
      {/* Pared del fondo */}
      <path d="M 0 60 Q 100 45 200 60 Q 350 80 480 60 Q 600 50 720 70 Q 850 85 980 65 Q 1100 50 1200 70 L 1200 380 L 0 380 Z"
        fill="#3D2818" opacity="0.7" />
      ...
      {/* Pintura rupestre — mano (estilo Altamira) */}
      ...
      <path d="M 0 450 Q 200 430 400 445 Q 600 460 800 440 Q 1000 450 1200 435" fill="none" stroke="#3D2818" strokeWidth="2" />
      ...
      <g transform="translate(600, 480)">
        ...
        <ellipse cx="0" cy="0" rx="140" ry="100" fill="url(#kobazuloa-fire)" opacity="0.85">
          <animate attributeName="rx" values="140;155;140" dur="2.4s" repeatCount="indefinite" />
        </ellipse>
        {/* Llamas */}
        ...
        {/* Chispas */}
        <circle cx="-8" cy="-20" r="0.8" fill="#FFD53D">
          <animate attributeName="cy" values="-20;-50;-50" dur="2s" repeatCount="indefinite" />
          <animate attributeName="opacity" values="1;1;0" dur="2s" repeatCount="indefinite" />
        </circle>
        <circle cx="6" cy="-15" r="0.7" fill="#FFD53D">
          <animate attributeName="cy" values="-15;-45;-45" dur="2.4s" repeatCount="indefinite" begin="0.8s" />
          <animate attributeName="opacity" values="1;1;0" dur="2.4s" repeatCount="indefinite" begin="0.8s" />
        </circle>
      </g>

      {/* Jentilak en la oscuridad — silueta vagamente humana */}
...
// ============================================================
// IRATIA — Bosque nocturno, luciérnagas, sorgina
// ============================================================
function IratiaMap() {
  return (
    <g>
            ...
            <g key={i}>
              <circle cx={x} cy={y} r="3.5" fill="#A8FFA8" filter="url(#iratia-glow)" opacity="0.9">
                <animate attributeName="opacity" values="0.2;1;0.2"
                  dur={`${1.5 + (i % 4) * 0.4}s`} repeatCount="indefinite"
                  begin={`${(i * 0.3) % 2}s`} />
                <animate attributeName="cy"
                  values={`${y};${y - 18};${y}`}
                  dur={`${3 + (i % 3) * 0.5}s`} repeatCount="indefinite" />
              </circle>
      ...
      {/* Sorgina más detallada */}
      <g transform="translate(640, 420)" opacity="0.7">
        {/* Cuerpo / capa */}
        <path d="M -16 36 L -14 0 L 14 0 L 16 36 Z" fill="#0A0E1A" />
        {/* Cabeza */}
        <circle cx="0" cy="-8" r="9" fill="#1A1A2E" />
        {/* Sombrero puntiagudo */}
        <path d="M -12 -10 L 0 -36 L 12 -10 Z" fill="#0A0E1A" />
        {/* Ala del sombrero */}
        <ellipse cx="0" cy="-9" rx="17" ry="3" fill="#0A0E1A" />
        {/* Ojos brillantes */}
        <circle cx="-3" cy="-9" r="1" fill="#FFD53D" />
        <circle cx="3" cy="-9" r="1" fill="#FFD53D" />
        {/* Escoba */}
        <line x1="13" y1="20" x2="32" y2="42" stroke="#3D2A20" strokeWidth="2.5" />
        <path d="M 28 38 L 38 48 L 32 50 L 26 46 Z" fill="#5B8B3A" />
        <line x1="28" y1="38" x2="36" y2="50" stroke="#5B8B3A" strokeWidth="0.8" />
        <line x1="32" y1="40" x2="38" y2="50" stroke="#5B8B3A" strokeWidth="0.8" />
      </g>
...
// ============================================================
// AKELARRE — Aquelarre, sabbat de sorginak en círculo de piedras
// ============================================================
function AkelarreMap() {
  return (
    <g>
      ...
      {/* Círculo de piedras (megalitos al estilo Stonehenge) */}
      <g fill="#0F0512">
      ...
      <g transform="translate(600, 520)">
        ...
        <ellipse cx="0" cy="-10" rx="170" ry="120" fill="url(#akelarre-fire)" opacity="0.85">
          <animate attributeName="rx" values="170;185;170" dur="2.6s" repeatCount="indefinite" />
        </ellipse>
        {/* Llamas */}
...
// ============================================================
// BURDINOLA — Ferrería de los jentilak
// ============================================================
function BurdinolaMap() {
  return (
    <g>
      ...
      {/* Martillo */}
      <g transform="translate(600, 380) rotate(-25)">
        <rect x="-3" y="0" width="6" height="100" fill="#3D2A20" />
        <rect x="-22" y="-18" width="44" height="22" rx="3" fill="#1A1A2E" />
        <rect x="-20" y="-14" width="40" height="6" fill="#3A3A4A" opacity="0.7" />
      </g>

      {/* Chispas volando desde el yunque */}
      <g fill="#FFD53D">
        {Array.from({ length: 10 }, (_, i) => {
          const x = 600 + ((i * 47) % 60) - 30
          const y = 460
          const dx = ((i * 23) % 80) - 40
          return (
            <circle key={i} cx={x} cy={y} r={0.8 + (i % 3) * 0.3}>
              <animate attributeName="cy" values={`${y};${y - 120};${y - 120}`}
                dur={`${1.5 + (i % 4) * 0.3}s`} repeatCount="indefinite"
                begin={`${(i * 0.15) % 1.5}s`} />
              <animate attributeName="cx" values={`${x};${x + dx};${x + dx}`}
                dur={`${1.5 + (i % 4) * 0.3}s`} repeatCount="indefinite"
                begin={`${(i * 0.15) % 1.5}s`} />
      ...
      {/* Silueta de jentil (gigante) trabajando — izquierda */}
...
// ============================================================
// ITSASERTZA — Acantilados con olas y faro
// ============================================================
function ItsasertzaMap() {
  return (
    <g>
      ...
      {/* Faro encima del acantilado izquierda */}
      <g transform="translate(180, 130)">
        {/* Cuerpo del faro: blanco y rojo */}
        ...
        {/* Haz de luz */}
        <path d="M 14 -8 L 600 -100 L 600 -50 Z" fill="#FFFDE7" opacity="0.15">
          <animate attributeName="opacity" values="0.15;0.05;0.15" dur="3s" repeatCount="indefinite" />
        </path>
      </g>

      {/* Hierba en el acantilado */}
      <g fill="#5B8B3A">
      ...
      {/* Gaviotas */}
      <g fill="#FFFDE7">
        <path d="M 460 180 q 12 -10 24 0 q -12 -4 -24 0 z" />
        <path d="M 600 230 q 9 -8 18 0 q -9 -3 -18 0 z" />
        <path d="M 720 200 q 11 -9 22 0 q -11 -4 -22 0 z" />
        <path d="M 540 280 q 8 -6 16 0 q -8 -2 -16 0 z" />
        <path d="M 820 250 q 10 -8 20 0 q -10 -3 -20 0 z" />
      </g>

      {/* Olas chocando contra acantilados — izquierda */}
      ...
      <ellipse cx="380" cy="340" rx="40" ry="20" fill="#FFFDE7" opacity="0.9">
        <animate attributeName="rx" values="40;55;40" dur="2.5s" repeatCount="indefinite" />
      </ellipse>
      {/* Salpicaduras */}
      <circle cx="370" cy="310" r="2.5" fill="#FFFDE7" opacity="0.8">
        <animate attributeName="cy" values="310;290;330" dur="2s" repeatCount="indefinite" />
        <animate attributeName="opacity" values="0.8;1;0" dur="2s" repeatCount="indefinite" />
      </circle>
      <circle cx="390" cy="305" r="2" fill="#FFFDE7" opacity="0.8">
        <animate attributeName="cy" values="305;280;325" dur="2.2s" repeatCount="indefinite" begin="0.5s" />
        <animate attributeName="opacity" values="0.8;1;0" dur="2.2s" repeatCount="indefinite" begin="0.5s" />
      </circle>

      {/* Olas chocando — derecha */}
      <ellipse cx="960" cy="370" rx="40" ry="22" fill="#FFFDE7" opacity="0.75">
        <animate attributeName="rx" values="40;55;40" dur="2.8s" repeatCount="indefinite" />
      </ellipse>
...
// ============================================================
// LARRE — Prado verde con pottokas
// ============================================================
function LarreMap() {
  return (
    <g>
      ...
      {/* Montañas lejanas */}
      <g>
        <path d="M 0 360 L 0 280 L 80 220 L 150 270 L 220 230 L 300 280 L 380 240 L 460 290 L 540 240 L 620 280 L 700 230 L 780 270 L 860 230 L 940 280 L 1020 240 L 1100 290 L 1200 250 L 1200 360 Z"
          fill="#7B8B9B" opacity="0.6" />
      </g>
      <g>
        <path d="M 0 360 L 100 310 L 200 340 L 320 290 L 450 330 L 580 285 L 720 325 L 850 280 L 980 325 L 1100 295 L 1200 330 L 1200 360 Z"
          fill="#9BAFC0" opacity="0.7" />
      </g>

      {/* Caserío (caserío vasco) al fondo */}
      ...
      {/* Pottoka (caballo pequeño) — izquierda */}
      ...
      {/* Mariposas */}
      <g>
        <g transform="translate(280, 320)" fill="#FFD53D" opacity="0.9">
          <ellipse cx="-3" cy="0" rx="4" ry="6" />
          <ellipse cx="3" cy="0" rx="4" ry="6" />
          <ellipse cx="-3" cy="6" rx="3" ry="4" />
          <ellipse cx="3" cy="6" rx="3" ry="4" />
        ...
        <g transform="translate(600, 380)" fill="#FF7E55" opacity="0.85">
          <ellipse cx="-3" cy="0" rx="4" ry="6" />
          <ellipse cx="3" cy="0" rx="4" ry="6" />
      ...
      {/* Brizna de hierba en primer plano */}
...
function MenditontorraMap() {
  return (
    <g>
      ...
      {/* Picos lejanos azules */}
      <path d="M 0 600 L 0 400 L 100 320 L 200 380 L 320 280 L 440 350 L 580 260 L 720 340 L 850 260 L 980 330 L 1100 280 L 1200 360 L 1200 600 Z"
        fill="#4F6F8F" opacity="0.7" />
      ...
      {/* Pico principal central */}
      <path d="M 300 600 L 380 480 L 460 400 L 540 320 L 600 240 L 660 320 L 740 400 L 820 480 L 900 600 Z"
        fill="#5A6F8F" />
      <path d="M 600 240 L 660 320 L 740 400 L 820 480 L 900 600 L 600 600 Z"
        fill="#3D5577" opacity="0.65" />

      {/* Capa de nieve en el pico */}
